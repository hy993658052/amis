  ...
  return [{
    ...
    children: [{
      ...
      schema: {
        type: 'wrapper',
        className: 'p-none',
        body: [getArgsWrapper([getSchemaTpl('apiControl', {
          name: 'api',
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            dataSchema = _c.sent();
            dataSchemaIns = new DataSchema(dataSchema || []);
            ...
            form.setValueByName('__cmptVariablesWithSys', __spreadArray([
            // 组件上下文+页面+系统
            {
          ...
          switch (_w.label) {
            case 0:
              ...
              if (action.actionType === 'ajax' && typeof ((_o = action === null || action === void 0 ? void 0 : action.args) === null || _o === void 0 ? void 0 : _o.api) === 'string') {
                action.args.api = normalizeApi((_p = action === null || action === void 0 ? void 0 : action.args) === null || _p === void 0 ? void 0 : _p.api);
              }
