...
var DataPickerControl = /** @class */ (function (_super) {
    ...
    DataPickerControl.prototype.render = function () {
        ...
        return (React__default.createElement(FormulaPicker, { onPickerOpen: this.handlePickerOpen, evalMode: false, onConfirm: this.handleConfirm, value: value, onChange: function () { }, header: '' }, function (_a) {
