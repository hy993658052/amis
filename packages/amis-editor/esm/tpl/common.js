...
import { setSchemaTpl, defaultValue, getSchemaTpl, tipedLabel, isObject } from 'amis-editor-core';
...
setSchemaTpl('optionsMenuTpl', function (config) {
  ...
  function getOptionVars(that) {
    ...
    if (schema.options) {
      var optionItem_1 = _.reduce(schema.options, function (result, item) {
        return __assign(__assign({}, result), item);
      }, {});
      optionItem_1 === null || optionItem_1 === void 0 ? true : delete optionItem_1.$$id;
      optionItem_1 = _.omit(optionItem_1, _.map(children, function (item) {
        return item === null || item === void 0 ? void 0 : item.label;
      }));
      var otherItem = _.map(_.keys(optionItem_1), function (item) {
        return {
