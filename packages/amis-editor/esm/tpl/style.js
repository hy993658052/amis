 ...
 */
// css类名
setSchemaTpl('theme:classNames', function (config) {
  var _a = config || {},
    _b = _a.isFormItem,
    isFormItem = _b === void 0 ? true : _b;
    _a.unsupportStatic;
...
setSchemaTpl('theme:common', function (exclude, include) {
  // key统一转换成Kebab case，eg: boxShadow => bos-shadow
  exclude = (exclude ? Array.isArray(exclude) ? exclude : [exclude] : []).map(function (key) {
    return kebabCase(key);
  });
  ...
  return [{
    ...
    header: i18n("39003734d1d700d5bd97bf1e7a2fcf73"),
    key: 'style',
    ...
    header: i18n("0103eb2d3dca70270d1a74e9ec987ac9"),
    key: 'radius',
    body: []
  }, {
    header: i18n("60bac4c0a381a42b320a703227be59eb"),
    key: 'box-model',
    body: []
  }, {
    header: i18n("8e1b944f4389bdaab6f11d5bc83190c8"),
