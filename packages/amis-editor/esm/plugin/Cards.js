...
import { getSchemaTpl, defaultValue, diff, repeatArray, JSONPipeOut, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
...
var CardsPlugin = /** @class */function (_super) {
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return [getSchemaTpl('tabs', [{
        ...
        body: [getSchemaTpl('layout:originPosition', {
          ...
          description: i18n("7ea26d0cb93e59339daf6a1ac68624f3"),
          test: !isCRUDBody
        ...
        body: [getSchemaTpl('switch', {
          name: 'showHeader',
          label: i18n("e18d033cc4baab3ebb329f6b29eb3cef"),
          pipeIn: defaultValue(true)
        }), getSchemaTpl('switch', {
          name: 'showFooter',
          label: i18n("412593f58b9d062a43cbe2ce38f4dc65"),
          pipeIn: defaultValue(true)
        }), getSchemaTpl('className', {
          label: i18n("4434b33a8731a73613ba5fa1eb984efb")
        }), getSchemaTpl('className', {
          name: 'headerClassName',
          label: i18n("e494f1aa112068688ca863db7f39a0b5")
        }), getSchemaTpl('className', {
          name: 'footerClassName',
          label: i18n("d267231d2d8b60e267acc7d7d9955ae2")
        }), getSchemaTpl('className', {
          name: 'itemsClassName',
          ...
          name: 'itemClassName',
          label: i18n("b2d2593bfb7a627817c0bd1ef6a254a8")
        }), {
          name: 'columnsCount',
          type: 'input-range',
          ...
          max: 12,
          step: 1,
          label: i18n("58e78d512d9ff40c73a263ab616cc652"),
  ...
  CardsPlugin.prototype.filterProps = function (props) {
    ...
    var arr = Array.isArray(props.value) ? props.value : typeof props.source === 'string' ? resolveVariable(props.source, data) : resolveVariable('items', data);
    ...
    return __assign(__assign({}, JSONPipeOut(rest)), {
      $schema: $schema
    });
  };
