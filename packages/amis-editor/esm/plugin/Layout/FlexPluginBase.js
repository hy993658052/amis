...
var FlexPluginBase = /** @class */function (_super) {
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return [getSchemaTpl('tabs', [{
        ...
        body: [getSchemaTpl('collapseGroup', [{
          ...
          body: __spreadArray(__spreadArray([isSorptionContainer ? getSchemaTpl('layout:sorption') : null], __read(isSorptionContainer ? [] : positionTpl), false), [getSchemaTpl('layout:flexDirection', {
            name: 'direction'
          ...
          getSchemaTpl('layout:justifyContent', {
            ...
            visibleOn: 'data.direction === "row" || data.direction === "row-reverse"'
          }), getSchemaTpl('layout:flex-wrap'), isFlexItem ? getSchemaTpl('layout:flex', {
        ...
        className: 'p-none',
        body: getSchemaTpl('collapseGroup', __spreadArray(__spreadArray([], __read(getSchemaTpl('style:common', [])), false), [{
          title: i18n("4434b33a8731a73613ba5fa1eb984efb"),
          body: [getSchemaTpl('className', {
            label: i18n("023c4bfc60545a2668c2d5111171b5d8")
          })]
        }], false))
      }])];
    };
  ...
  FlexPluginBase.prototype.buildEditorToolbar = function (_a, toolbars) {
    ...
    !draggableContainer && !(schema === null || schema === void 0 ? void 0 : schema.isFreeContainer)) {
      ...
      if (!toolbarsTooltips[i18n("dbb93e8f413074ead24b6ed822247d98")]) {
        toolbars.push({
          iconSvg: 'add-btn',
