...
import { getI18nEnabled, getSchemaTpl, tipedLabel, defaultValue, mockValue, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
    ...
    _this.events = [{
      ...
      dataSchema: [{
        ...
        properties: {
          'event.data.value': {
            type: 'object',
            title: i18n("aacd80d2c978abae7b955510a938788c")
          }
        }
      }]
    }, {
      ...
      dataSchema: [{
        ...
        properties: {
          'event.data.key': {
            type: 'string',
            title: i18n("0410242a74850f010a9a8061bc0cd891")
          },
          'event.data.value': {
            type: 'string',
            title: i18n("74333901ae9ad27a93487dc850e45609")
          },
          'event.data.item': {
            type: 'object',
