...
import { getI18nEnabled, getSchemaTpl, defaultValue, tipedLabel, mockValue, repeatArray, diff, BasePlugin, registerEditorPlugin } from 'amis-editor-core';
...
var TablePlugin = /** @class */function (_super) {
      ...
      return getSchemaTpl('tabs', [{
        ...
        body: getSchemaTpl('collapseGroup', [{
          ...
          body: [{
            ...
            label: i18n("14921c3831512876f6d58b2a497b86df"),
            ...
            description: i18n("6fe0b71c07a5ce5f7a09f7fdb1d63827")
          }, getSchemaTpl('switch', {
            name: 'affixHeader',
  ...
  TablePlugin.prototype.buildDataSchemas = function (node, region, trigger) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
      var itemsSchema, columns, _c, _d, current, schema, _e, _f, _g, e_1_1, cellProperties, isColumnChild;
      var e_1, _h;
      return __generator(this, function (_j) {
        switch (_j.label) {
          ...
          case 1:
            ...
            _c = __values(columns === null || columns === void 0 ? void 0 : columns.children), _d = _c.next();
            _j.label = 2;
          case 2:
            if (!!_d.done) return [3 /*break*/, 7];
            current = _d.value;
            schema = current.schema;
            if (!schema.name) return [3 /*break*/, 6];
