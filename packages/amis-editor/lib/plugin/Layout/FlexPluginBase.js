...
var FlexPluginBase = /** @class */function (_super) {
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return [amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: [amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: tslib.__spreadArray(tslib.__spreadArray([isSorptionContainer ? amisEditorCore.getSchemaTpl('layout:sorption') : null], tslib.__read(isSorptionContainer ? [] : positionTpl), false), [amisEditorCore.getSchemaTpl('layout:flexDirection', {
            name: 'direction'
          ...
          amisEditorCore.getSchemaTpl('layout:justifyContent', {
            ...
            visibleOn: 'data.direction === "row" || data.direction === "row-reverse"'
          }), amisEditorCore.getSchemaTpl('layout:flex-wrap'), isFlexItem ? amisEditorCore.getSchemaTpl('layout:flex', {
        ...
        className: 'p-none',
        body: amisEditorCore.getSchemaTpl('collapseGroup', tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(amisEditorCore.getSchemaTpl('style:common', [])), false), [{
          title: i18nRuntime.i18n("4434b33a8731a73613ba5fa1eb984efb"),
          body: [amisEditorCore.getSchemaTpl('className', {
            label: i18nRuntime.i18n("023c4bfc60545a2668c2d5111171b5d8")
          })]
        }], false))
      }])];
    };
  ...
  FlexPluginBase.prototype.buildEditorToolbar = function (_a, toolbars) {
    ...
    if (parent && (((_d = info.renderer) === null || _d === void 0 ? void 0 : _d.name) === 'flex' || ((_e = info.renderer) === null || _e === void 0 ? void 0 : _e.name) === 'container') && !isFlexItem &&
    // 备注：如果是列级元素就不需要显示了
    !draggableContainer && !(schema === null || schema === void 0 ? void 0 : schema.isFreeContainer)) {
      // 非特殊布局元素（fixed、absolute）支持前后插入追加布局元素功能icon
      if (!toolbarsTooltips[i18nRuntime.i18n("dbb93e8f413074ead24b6ed822247d98")]) {
        toolbars.push({
          iconSvg: 'add-btn',
      ...
      // 布局容器 右上角插入子元素
      if (((_f = info.renderer) === null || _f === void 0 ? void 0 : _f.name) === 'flex') {
