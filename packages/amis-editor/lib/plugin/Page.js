  ...
  function PagePlugin() {
    ...
    _this.panelBodyCreator = function (context) {
      return [amisEditorCore.getSchemaTpl('tabs', [{
        ...
        className: 'p-none',
        body: [amisEditorCore.getSchemaTpl('collapseGroup', tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(amisEditorCore.getSchemaTpl('theme:common', ['layout'])), false), [amisEditorCore.getSchemaTpl('style:classNames', {
          isFormItem: false,
