      ...
      dataSchema: [{
        ...
        properties: {
          ...
          'event.data.selectedItems': {
            type: 'string',
            title: i18nRuntime.i18n("54d621d5bd588bea4e896de52147a229")
          }
        }
      }]
    }, {
    ...
    _this.panelBodyCreator = function (context) {
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
          ...
          }, amisEditorCore.getSchemaTpl('multiple'), amisEditorCore.getSchemaTpl('joinValues'), amisEditorCore.getSchemaTpl('delimiter'), amisEditorCore.getSchemaTpl('extractValue'), amisEditorCore.getSchemaTpl('autoFillApi', {
