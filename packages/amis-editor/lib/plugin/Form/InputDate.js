    ...
    _this.events = [{
      ...
      dataSchema: [{
        ...
        properties: {
          'event.data.value': {
            type: 'string',
            title: i18nRuntime.i18n("0a72b3858efffaa1bab685fa840b701b")
          }
        }
      }]
    }, {
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            onChange: function (value, oldValue, model, form) {
              ...
              if (type === 'time') {
                var timeFormatObj = DateType[type].formatOptions.find(function (item) {
                  return item.value === value;
                });
                var timeFormat = timeFormatObj ? timeFormatObj.timeFormat : 'HH:mm:ss';
                form.setValues({
            ...
            rendererSchema: tslib.__assign({}, context === null || context === void 0 ? void 0 : context.schema),
