...
var getFormItemOptions = function (_a) {
  ...
  return [{
    name: 'type',
    label: i18nRuntime.i18n("cd948961f71f87ecc72b251147d96144"),
    type: 'select',
    required: true,
    options: [{
    ...
    name: 'label',
    label: i18nRuntime.i18n("fdf6f7f6497556de440fe434b721ee99"),
    type: i18nEnabled ? 'input-text-i18n' : 'input-text',
    hiddenOn: 'data.type === "group"'
  }, {
    name: 'name',
    label: i18nRuntime.i18n("712538d3e674792ec94feb9a5eb2cc0a"),
    required: true,
    type: 'input-text',
    hiddenOn: 'data.type === "group"'
  }];
...
var FormPlugin = /** @class */function (_super) {
  ...
  Object.defineProperty(FormPlugin.prototype, "scaffoldForm", {
    get: function () {
      var i18nEnabled = amisEditorCore.getI18nEnabled();
      return {
        title: i18nRuntime.i18n("1b6f9adf1e6a41a18b9a76407d945618"),
        body: [amisEditorCore.getSchemaTpl('apiControl', {
          label: i18nRuntime.i18n("380c80efc8d38510d31f50578690b781")
        }), {
          name: 'mode',
          label: i18nRuntime.i18n("ffc2c1671eb7e3f6751006cd7a9961f4"),
          type: 'button-group-select',
          pipeIn: amisEditorCore.defaultValue('normal', false),
          options: [{
            label: i18nRuntime.i18n("81f8a50d084992815ab844109b3ea27f"),
            value: 'normal'
          }, {
            label: i18nRuntime.i18n("3720b9ef8053b7b8a54c7d8ace051912"),
            value: 'horizontal'
          ...
          label: i18nRuntime.i18n("9d68944682609cb230534195ca7c62ae"),
          type: 'combo',
          name: 'body',
          multiple: true,
          draggable: true,
          ...
          items: tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(getFormItemOptions({
            ...
            type: 'combo',
            name: 'body',
            label: i18nRuntime.i18n("cf993a1d9c0352215055d180aca60b97"),
            multiple: true,
            draggable: true,
            multiLine: true,
