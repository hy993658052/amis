...
var Editor = require('amis/lib/renderers/Form/Editor');
...
var CodeEditorControlPlugin = /** @class */function (_super) {
  ...
  function CodeEditorControlPlugin() {
    ...
    _this.description = "\u4EE3\u7801\u7F16\u8F91\u5668\uFF0C\u91C7\u7528 monaco-editor \u652F\u6301\uFF1A".concat(Editor.availableLanguages.slice(0, 10).join('，'), "\u7B49\u7B49");
    ...
    _this.events = [{
      ...
      dataSchema: [{
        ...
        properties: {
          'event.data.value': {
            type: 'string',
            title: i18nRuntime.i18n("efa3ddc1e26ed5d8cf7d9855cc7bd42e")
          }
        }
      }]
    }, {
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            value: 'javascript',
            searchable: true,
            options: Editor.availableLanguages.concat()
