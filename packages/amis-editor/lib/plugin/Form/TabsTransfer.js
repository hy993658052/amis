    ...
    _this.events = [{
      ...
      dataSchema: [{
        ...
        properties: {
          'event.data.key': {
            type: 'string',
            title: i18nRuntime.i18n("9e7a97a3d043f566f2435329e01e09f9")
          }
        }
      }]
    }];
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [{
          ...
          body: [amisEditorCore.getSchemaTpl('layout:originPosition', {
            ...
            required: true
          }), amisEditorCore.getSchemaTpl('label'), amisEditorCore.getSchemaTpl('searchable'), amisEditorCore.getSchemaTpl('api', {
            label: i18nRuntime.i18n("791959f9b90734dce08da79f4ac27a41"),
            name: 'searchApi'
          }), {
          ...
          body: [{
            $ref: 'options',
            name: 'options'
          }, amisEditorCore.getSchemaTpl('source'), amisEditorCore.getSchemaTpl('loadingConfig', {
