    ...
    _this.events = [{
      ...
      dataSchema: [{
        ...
        properties: {
          'event.data.value': {
            type: 'string',
            title: i18nRuntime.i18n("b35014ec330e91860bb188200fba12db")
          }
        }
      }]
    }, {
      ...
      dataSchema: [{
        ...
        properties: {
          'event.data.value': {
            type: 'object',
            title: i18nRuntime.i18n("5f5e2d89e987fa64d56471b2e3d50cda")
          },
          'event.data.items': {
            type: 'array',
      ...
      dataSchema: [{
        ...
        properties: {
          'event.data.value': {
            type: 'object',
            title: i18nRuntime.i18n("25a4d7b5ce2585aada1205e1121e9967")
          },
          'event.data.items': {
            type: 'array',
            title: i18nRuntime.i18n("cf965b232227a0e9d14f4f7e31b01c62")
      ...
      dataSchema: [{
        ...
        properties: {
          'event.data.value': {
            type: 'object',
            title: i18nRuntime.i18n("7768e7d47fa6e9b811d1a1f684703cfb")
          },
          'event.data.items': {
            type: 'array',
            title: i18nRuntime.i18n("cf965b232227a0e9d14f4f7e31b01c62")
          ...
          body: [amisEditorCore.getSchemaTpl('treeOptionControl', {
            ...
            form: {
              body: [amisEditorCore.getSchemaTpl('switch', {
                ...
                type: 'input-text',
                label: i18nRuntime.i18n("89664aa96ba7eb788ea273c0d36467cc"),
                value: i18nRuntime.i18n("b4eab506cf436d3cdd1cd68fc857ec04"),
                name: 'rootCreateTip',
                hiddenOn: '!data.rootCreatable'
              }, amisEditorCore.getSchemaTpl('addApi')]
            }
