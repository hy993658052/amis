    ...
    // },
    {
      ...
      dataSchema: [{
        ...
        properties: {
          'event.data.value': {
            type: 'string',
            title: i18nRuntime.i18n("acc945d0c8449dce7dc1441f466ec413")
          }
        }
      }]
    }, {
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return amisEditorCore.getSchemaTpl('tabs', [{
        ...
        body: amisEditorCore.getSchemaTpl('collapseGroup', [amisEditorCore.getSchemaTpl('style:formItem', {
          ...
          }], tslib.__read(inputStateFunc("${editorState == 'default' || !editorState}", 'default')), false), tslib.__read(inputStateFunc("${editorState == 'hover'}", 'hover')), false), tslib.__read(inputStateFunc("${editorState == 'active'}", 'active')), false)
        }, {
          ...
          schema: [{
            ...
            label: i18nRuntime.i18n("9b6425cd2d496c9cb5a6c6b8ff125d1b"),
