...
var ItemPlugin = /** @class */function (_super) {
  ...
  function ItemPlugin() {
    ...
    _this.panelBodyCreator = function (context) {
      ...
      return [amisEditorCore.getSchemaTpl('tabs', [{
        ...
        }) : null, amisEditorCore.getSchemaTpl('switch', {
          name: 'disabled',
        ...
        }), ignoreValidator ? null : amisEditorCore.getSchemaTpl('required'), amisEditorCore.getSchemaTpl('description'), amisEditorCore.getSchemaTpl('placeholder'), amisEditorCore.getSchemaTpl('remark', {
          mode: 'row'
        ...
        }), renderer.sizeMutable !== false ? amisEditorCore.getSchemaTpl('formItemSize') : null, amisEditorCore.getSchemaTpl('formItemInline'), amisEditorCore.getSchemaTpl('className'), amisEditorCore.getSchemaTpl('className', {
        ...
        amisEditorCore.getSchemaTpl('disabled'), amisEditorCore.getSchemaTpl('visible'), supportStatic ? amisEditorCore.getSchemaTpl('static') : null, amisEditorCore.getSchemaTpl('switch', {
  ...
  ItemPlugin.prototype.afterUpdate = function (event) {
    ...
    if (/\$/.test(context.info.renderer.name) && ((_a = context.diff) === null || _a === void 0 ? void 0 : _a.some(function (change) {
      var _a;
