...
amisEditorCore.setSchemaTpl('initFetch', function (overrides) {
  ...
  var visibleOn = _.get(overrides, 'visibleOn', 'this.initApi');
  var fieldName = _.get(overrides, 'name', 'initFetch');
  var label = _.get(overrides, 'label', i18nRuntime.i18n("47d0a7caaa2baee8d38612a1c57421ef"));
  return {
    type: 'group',
...
amisEditorCore.setSchemaTpl('interval', function (more) {
  if (more === void 0) {
    more = {};
  }
  return tslib.__assign({
