...
amisEditorCore.setSchemaTpl('layout:display', function (config) {
  var configOptions = [{
    label: i18nRuntime.i18n("cb048b2d8426afd464dc01b72c446342"),
    value: 'block'
  }, {
    label: i18nRuntime.i18n("b5f55e5c7101d9be5218d63850e1ad8b"),
    value: 'flex'
  }, {
    label: i18nRuntime.i18n("4180e30c34190007ffaa654e0959b8a3"),
    value: 'inline-flex'
  }, {
    label: i18nRuntime.i18n("ebe7bde5c9094813e2924473488d281a"),
    value: 'inline-block'
  }, {
...
amisEditorCore.setSchemaTpl('layout:justifyContent', function (config) {
  ...
  var configSchema = {
    type: 'select',
    label: (config === null || config === void 0 ? void 0 : config.label) || amisEditorCore.tipedLabel("\u6C34\u5E73\u5BF9\u9F50\u65B9\u5F0F", i18nRuntime.i18n("0a0574baedb8eb2abf7daf25159d8bb1")),
...
amisEditorCore.setSchemaTpl('layout:alignItems', function (config) {
  ...
  var configSchema = {
    type: 'select',
    label: (config === null || config === void 0 ? void 0 : config.label) || amisEditorCore.tipedLabel("\u5782\u76F4\u5BF9\u9F50\u65B9\u5F0F", i18nRuntime.i18n("5ccc4c05cd41195f202f550a4c307a64")),
