...
amisEditorCore.setSchemaTpl('optionsMenuTpl', function (config) {
  ...
  function getOptionVars(that) {
    ...
    if (schema.options) {
      var optionItem_1 = ___default["default"].reduce(schema.options, function (result, item) {
        return tslib.__assign(tslib.__assign({}, result), item);
      }, {});
      optionItem_1 === null || optionItem_1 === void 0 ? true : delete optionItem_1.$$id;
      optionItem_1 = ___default["default"].omit(optionItem_1, ___default["default"].map(children, function (item) {
        return item === null || item === void 0 ? void 0 : item.label;
      }));
      var otherItem = ___default["default"].map(___default["default"].keys(optionItem_1), function (item) {
        return {
...
amisEditorCore.setSchemaTpl('textareaDefaultValue', {
  type: 'ae-textareaFormulaControl',
