...
var DataBindingControl = /** @class */function (_super) {
  ...
  var _a;
  tslib.__decorate([amisEditorCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [typeof (_a = typeof amisEditorCore.DSField !== "undefined" && amisEditorCore.DSField) === "function" ? _a : Object]), tslib.__metadata("design:returntype", void 0)], DataBindingControl.prototype, "handleConfirm", null);
...
var SimpleDataBindingControl = /** @class */function (_super) {
  ...
  function SimpleDataBindingControl(props) {
    var _this = _super.call(this, props) || this;
    _this.handleSearchDebounced = _.debounce(_this.handleSearch, 250, {
      trailing: true,
      leading: false
    });
    _this.state = {
  ...
  SimpleDataBindingControl.prototype.render = function () {
    ...
    return React__default["default"].createElement("div", {
      ...
      expandIcon: amisCore.generateIcon(cx__default["default"], 'fa fa-chevron-right expandIcon', 'Icon'),
