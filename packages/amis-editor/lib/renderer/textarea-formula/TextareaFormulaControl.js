...
var CodeMirrorEditor = require('amis-ui/lib/components/CodeMirror');
...
var CodeMirrorEditor__default = /*#__PURE__*/_interopDefaultLegacy(CodeMirrorEditor);
...
var TextareaFormulaControl = /** @class */function (_super) {
  ...
  function TextareaFormulaControl(props) {
    ...
    _this.handleOnChange = debounce__default["default"](function (value) {
      var _a, _b;
  ...
  TextareaFormulaControl.prototype.editorFactory = function (dom, cm) {
    ...
    return plugin.editorFactory(dom, cm, tslib.__assign(tslib.__assign({}, this.props), {
      variables: variables
    }));
  };
  TextareaFormulaControl.prototype.handleEditorMounted = function (cm, editor) {
    var _this = this;
    var variables = this.props.variables || this.state.variables;
    this.editorPlugin = new plugin.FormulaPlugin(editor, cm, function () {
  ...
  TextareaFormulaControl.prototype.render = function () {
    ...
    }, React__default["default"].createElement(CodeMirrorEditor__default["default"], {
    ...
    }) : null, formulaPickerOpen ? React__default["default"].createElement(FormulaPickerCmp, tslib.__assign({}, this.props, {
  ...
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [String, Array]), tslib.__metadata("design:returntype", void 0)], TextareaFormulaControl.prototype, "onExpressionClick", null);
  ...
  tslib.__decorate([amisCore.autobind, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", []), tslib.__metadata("design:returntype", void 0)], TextareaFormulaControl.prototype, "handleFormulaClick", null);
