...
var EventControl = /** @class */function (_super) {
  ...
  EventControl.prototype.getEventVariables = function (activeData) {
    ...
    (_a = eventConfig === null || eventConfig === void 0 ? void 0 : eventConfig.dataSchema) === null || _a === void 0 ? void 0 : _a.forEach(function (ds) {
      ...
      eventVariables[0].children = tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(eventVariables[0].children), false), tslib.__read(dataSchema.getDataPropsAsOptions()), false);
    });
      ...
      return tslib.__generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 2:
            ...
            variables = tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(eventVariables), false), tslib.__read(rawVariables), false);
  ...
  EventControl.prototype.render = function () {
    ...
    var eventSnapshot = cloneDeep__default["default"](onEvent);
    ...
    return React__default["default"].createElement("div", {
      ...
      return React__default["default"].createElement("li", {
        ...
        className: cx__default["default"]({
          ...
          'no-bd-btm': !(((_a = eventSnapshot[eventKey].actions) === null || _a === void 0 ? void 0 : _a.length) && eventPanelActive[eventKey]) && !helper.getEventStrongDesc(events, eventKey)
        })
      ...
      }) : null, eventSnapshot[eventKey].actions.length && eventPanelActive[eventKey] ? React__default["default"].createElement("ul", {
    ...
    }, i18nRuntime.i18n('4db5110d41293fef57f5a1f364187896'))), showEventDialog ? amis.render({
      type: 'dialog',
...
exports.IS_DATA_CONTAINER = helper.IS_DATA_CONTAINER;
