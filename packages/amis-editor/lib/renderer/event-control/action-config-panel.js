...
var ActionConfigPanel = /** @class */function (_super) {
  ...
  ActionConfigPanel.prototype.render = function () {
    ...
    if (data.actionType === 'component') {
      ...
      var baseSchema = helper.renderCmptActionSelect(i18nRuntime.i18n("d80bc0fcbfb250480320b683e48b1467"));
      // 追加到基础配置
    ...
    return schema ? render('inner', schema, {
      ...
      onChange: function (value, field) {
        var _a;
        onBulkChange((_a = {}, _a[field] = value, _a));
      }
