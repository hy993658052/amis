...
export declare const renderCmptActionSelect: (componentLabel: string, required: boolean, onChange?: ((value: string, oldVal: any, data: any, form: any) => void) | undefined) => ({
    type: string;
    name: string;
    label: string;
    showIcon: boolean;
...
export declare const getEventControlConfig: (manager: EditorManager, context: BaseEventContext) => {
    ...
    actionConfigInitFormatter: (action: ActionConfig, variables: {
    ...
    actionConfigSubmitFormatter: (config: ActionConfig) => ActionConfig;
};
