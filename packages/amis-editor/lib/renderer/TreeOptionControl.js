...
var TreeOptionControl = /** @class */function (_super) {
  ...
  TreeOptionControl.prototype.handleDelete = function (pathStr, index) {
    ...
    var options = cloneDeep__default["default"](this.state.options);
    if (options.length === 1) {
      amis.toast.warning(i18nRuntime.i18n("355c54009e364bf4396be424fba10e0f"), {
        closeButton: true
      });
      return;
    }
    ...
    if (path.length === 1) {
      ...
      if (!(parentNode === null || parentNode === void 0 ? void 0 : parentNode.children.length)) {
        // 去除僵尸子节点
  ...
  TreeOptionControl.prototype.renderModal = function () {
    ...
    }, "\u9009\u9879\u7BA1\u7406"), React__default["default"].createElement(amis.Modal.Body, null, React__default["default"].createElement("div", {
    ...
    }, "\u53D6\u6D88"), React__default["default"].createElement(amis.Button, {
      level: "primary",
      onClick: function () {
        _this.onChange();
  ...
  TreeOptionControl.prototype.render = function () {
    ...
    }, "\u9009\u9879\u7BA1\u7406"), this.renderModal())) : null, this.renderApiPanel());
  };
